...
function getApiKey() {
    var env = process.env;
    var key = env.EXPO_PUBLIC_GROQ_API_KEY;
    return typeof key === "string" && key.length > 0 ? key : null;
}
function getModel() {
    var _a;
    var env = process.env;
    return (_a = env.EXPO_PUBLIC_GROQ_MODEL) !== null && _a !== void 0 ? _a : DEFAULT_MODEL;
}
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    apiKey = getApiKey();
                    if (!apiKey) {
                        throw new aiTypes_1.AIServiceError("config", "Groq API key missing. Add EXPO_PUBLIC_GROQ_API_KEY to a .env file.");
                    }
                ...
                case 1:
                    _f.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fetch(GROQ_ENDPOINT, {
                            method: "POST",
                            headers: {
